          ...
          contentEditable={
            <ContentEditable
              className={cn(
                ...
                "block max-h-50 min-h-12.5 w-full overflow-y-auto whitespace-pre-wrap wrap-break-word bg-transparent leading-relaxed text-foreground focus:outline-none",
                className,
              )}
