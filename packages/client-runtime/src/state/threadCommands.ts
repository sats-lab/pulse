...
import {
  ...
  type MutateThreadInputQueueInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    mutateInputQueue: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:mutate-input-queue",
      execute: (input: MutateThreadInputQueueInput) => mutateThreadInputQueue(input),
      scheduler,
      concurrency,
    }),
